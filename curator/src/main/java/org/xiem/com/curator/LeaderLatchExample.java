...
public class LeaderLatchExample {
	...
	// �쳣����:
	// LEADERLATCHʵ����������CONNECTIONSTATELISTENER������������������.��SUSPENDED��LOSTʱ,
	// LEADER������Ϊ�Լ�����LEADER.��LOST����������RECONNECTED,LEADERLATCH��ɾ����ǰ��ZNONEȻ�����´���һ��.
	// LEADERLATCH�û����뿼�ǵ���LEADER��ʧ����������.ǿ���Ƽ���ʹ��CONNECTIONSTATELISTENER
	...
	public static void main(String[] args) throws Exception {
		...
		TestingServer server = new TestingServer();// ��ʾ���Է�����
		...
		try {
			...
			currentLeader.close();// ֻ��ͨ��CLOSE�ͷ��쵼Ȩ

			examples.get(0).await(2, TimeUnit.SECONDS);// AWAIT��һ����������(���Ի�ȡLEADER��λ,����δ������λ)
